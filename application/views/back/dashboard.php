...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/back/bootsrap.min.css">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Brian Ismail</a>
                    </div>
                </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-sm-offset-4">
                                    ...
                                    <hr>
                                    <form method="POST" action="<?php echo base_url(); ?>index1.php/welcome/insert">
